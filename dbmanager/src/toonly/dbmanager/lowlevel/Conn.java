...
public class Conn implements Connection {
    ...
    public Conn(DS sds, Connection conn) {
        this.sds = sds;
        this.conn = conn;
    }
     ...
     * <p>
     * Calling the method <code>stopWatching</code> on a <code>Connection</code>
     * object that is already closed is a no-op.
     * <p>
     * It is <b>strongly recommended</b> that an application explicitly
     * commits or rolls back an active transaction prior to calling the
     * <code>stopWatching</code> method.  If the <code>stopWatching</code> method is called
    ...
    public void close() throws SQLException {
        this.sds.returnConn(this.conn);
        this.conn = null;
    }

    /**
     * Retrieves whether this <code>Connection</code> object has been
     * closed.  A connection is closed if the method <code>stopWatching</code>
     * has been called on it or if certain fatal errors have occurred.
     * This method is guaranteed to return <code>true</code> only when
     * it is called after the method <code>Connection.stopWatching</code> has
     * been called.
     * <p>
     ...
     * the objects, with the exception of the <code>stopWatching</code>,
